...
See [Customizing Drivers](customizing-drivers.md) for how to build on top of the generic driver.
...
- [Customizing Drivers](customizing-drivers.md) — extending existing drivers and creating new ones from scratch
- [Architecture](architecture.md) — how the driver system fits into the overall design
- [Glossary](glossary.md) — definitions of negation, idempotency, sectional rules, and other driver concepts
- [API Reference](api-reference.md) — auto-generated documentation for driver classes and rule models
