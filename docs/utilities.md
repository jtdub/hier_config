...
## Hier Config V2/V3 Migration Utilities

These utilities help you transition from v2-style configuration options and tags to the current driver format. They allow continued use of v2-style YAML options files while you update your tooling.
...
The returned driver will have rules grouped under `driver.rules.negation`, `driver.rules.idempotency`, `driver.rules.parsing`, `driver.rules.sectional`, etc. — merging your v2 options with the platform's built-in rules.
