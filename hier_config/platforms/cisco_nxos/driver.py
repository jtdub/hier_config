        ...
        return HConfigDriverRules(
            ...
            idempotency=IdempotencyRules(
                ...
                idempotent_commands=(
                    ...
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(startswith="port-channel load-balance"),
                        ),
                    ),
                    IdempotentCommandsRule(
                    ...
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(startswith="ip telnet source-interface"),
                        ),
                    ),
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(startswith="ip tacacs source-interface"),
                        ),
                    ),
                    IdempotentCommandsRule(
                    ...
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(
                                startswith="hardware access-list tcam region ifacl"
                            ),
                        ),
                    ),
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(
                                startswith="hardware access-list tcam region vacl"
                            ),
                        ),
                    ),
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(
                                startswith="hardware access-list tcam region qos"
                            ),
                        ),
                    ),
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(
                                startswith="hardware access-list tcam region racl"
                            ),
                        ),
                    ),
                    IdempotentCommandsRule(
                    ...
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(
                                startswith="hardware access-list tcam region l3qos"
                            ),
                        ),
                    ),
                    IdempotentCommandsRule(
                    ...
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(startswith="mac address-table aging-time"),
                        ),
                    ),
                    IdempotentCommandsRule(
                    ...
                    IdempotentCommandsRule(
                        match_rules=(
                            MatchRule(startswith="username admin password 5"),
                        ),
                    ),
                    IdempotentCommandsRule(
                        match_rules=(
